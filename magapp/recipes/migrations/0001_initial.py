# Generated by Django 4.0.10 on 2023-07-10 13:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abbr', models.CharField(help_text='Abreviação da métrica.', max_length=10, verbose_name='Abreviação')),
                ('name', models.CharField(help_text='Nome da métrica', max_length=20, verbose_name='nome')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('font', models.CharField(blank=True, help_text='Livro de receita, link do youtube e etc.', max_length=200, null=True, verbose_name='Fonte')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metric', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='recipes.metric')),
