...
MIGRATION_MODULES = {"sites": "magapp.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "magapp.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""Pedro Campos""", "pcampos119104@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "magapp.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "magapp.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
